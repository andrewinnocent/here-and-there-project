...
var eventHandlers = __webpack_require__(13);
...
var onClearForms = function onClearForms() {
...
var onSignOut = function onSignOut(event) {
  ...
  .then(notSignedIn).then(ui.clearEntries).catch(ui.signOutFailure);
};
...
var onSubmitEntry = function onSubmitEntry(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  ...
  // $('.rating').val()
  // console.log(data)
  api.createEntry(data).then(ui.entrySubmitSuccess).catch(ui.entrySubmitFailure);
...
var onGetEntries = function onGetEntries(event) {
  ...
  ui.clearEntries();
  api.getAllEntries().then(ui.getEntriesSuccess).catch(ui.getEntriesFailure);
};
...
var onGetEntry = function onGetEntry(event) {
  ...
  ui.clearEntries();
  api.getOneEntry(data).then(ui.getEntrySuccess).catch(ui.getEntryFailure);
...
var onUpdateEntry = function onUpdateEntry(event) {
  ...
  api.updateEntry(data).then(function () {
    return api.getOneEntry(data);
...
var onDeleteEntry = function onDeleteEntry(event) {
  ...
  api.deleteEntry(id).then(function () {
    return api.getAllEntries(event);
  }) // after deleting an entry, refetch all entries
  .then(ui.deleteEntrySuccess).catch(ui.deleteEntryFailure);
};
...
var entryHandlers = function entryHandlers() {
...
// Get one journal entry
var getOneEntry = function getOneEntry(data) {
  // console.log(data)
  return $.ajax({
...
var getOneEntryDOM = function getOneEntryDOM(data) {
  // console.log(data)
  return $.ajax({
...
var store = __webpack_require__(3);
var indexJournalsTemplate = __webpack_require__(17);
var indexJournalTemplate = __webpack_require__(34);
...
var entrySubmitSuccess = function entrySubmitSuccess() {
  $('#success-message').text('✈ Smooth Sailing!').fadeIn().fadeOut(3000);
};

var entrySubmitFailure = function entrySubmitFailure() {
...
module.exports = {
  ...
  entrySubmitSuccess: entrySubmitSuccess,
  entrySubmitFailure: entrySubmitFailure,
  getEntriesSuccess: getEntriesSuccess,
  getEntriesFailure: getEntriesFailure,
  getEntrySuccess: getEntrySuccess,
  getEntryFailure: getEntryFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<br>\n<br>\n  <div class=\"panel panel-default\">\n    <div class=\"panel-heading\">\n      <h3 class=\"panel-title\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location_name : stack1), depth0))
    + " in "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.state : stack1), depth0))
    + " (ID: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ")</h3>\n    </div>\n    <div class=\"panel-body\">\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.state : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.location_name : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.comments : stack1),{"name":"if","hash":{},"fn":container.program(14, data, 0, blockParams),"inverse":container.program(16, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.date : stack1),{"name":"if","hash":{},"fn":container.program(18, data, 0, blockParams),"inverse":container.program(20, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.time : stack1),{"name":"if","hash":{},"fn":container.program(22, data, 0, blockParams),"inverse":container.program(24, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      </div>\n\n      <button class=\"journal-delete btn btn-danger entry-delete-button\" class=\"entry-delete-button\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">\n        Delete\n      </button>\n\n      <button type=\"button\" class=\"journal-update btn btn-info entry-update-button\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + " data-target=\"#update-entry-modal\" data-toggle=\"modal\">\n      Update\n      </button>\n\n    </div>\n  </div>\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "          State: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.state : stack1), depth0))
    + "\n";
  ...
  return "          Location: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.location_name : stack1), depth0))
    + "\n";
  ...
  return "          Comments: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.comments : stack1), depth0))
    + "\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.journals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "          State: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.state : stack1), depth0))
    + "\n";
  ...
  return "          Location: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.location_name : stack1), depth0))
    + "\n";
  ...
  return "          Rating: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.rating : stack1), depth0))
    + "\n";
  ...
  return "          Comments: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.comments : stack1), depth0))
    + "\n";
  ...
  return "          Date: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.date : stack1), depth0))
    + "\n";
  ...
  return "          Time: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.time : stack1), depth0))
    + "\n";
  ...
  return "<br>\n<br>\n  <div class=\"panel panel-default\">\n    <div class=\"panel-heading\">\n      <h3 class=\"panel-title\" data-id="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.id : stack1), depth0))
    + ">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.location_name : stack1), depth0))
    + " in "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.state : stack1), depth0))
    + " (ID: "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.id : stack1), depth0))
    + ")</h3>\n    </div>\n    <div class=\"panel-body\">\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.state : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.location_name : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "")
    + "      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.rating : stack1),{"name":"if","hash":{},"fn":container.program(9, data, 0),"inverse":container.program(11, data, 0),"data":data})) != null ? stack1 : "")
    + "      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.comments : stack1),{"name":"if","hash":{},"fn":container.program(13, data, 0),"inverse":container.program(15, data, 0),"data":data})) != null ? stack1 : "")
    + "      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.date : stack1),{"name":"if","hash":{},"fn":container.program(17, data, 0),"inverse":container.program(19, data, 0),"data":data})) != null ? stack1 : "")
    + "      </div>\n      <div>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.time : stack1),{"name":"if","hash":{},"fn":container.program(21, data, 0),"inverse":container.program(23, data, 0),"data":data})) != null ? stack1 : "")
    + "      </div>\n\n      <button class=\"journal-delete btn btn-danger entry-delete-button\" class=\"entry-delete-button\" data-id="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.id : stack1), depth0))
    + ">\n        Delete\n      </button>\n\n      <button type=\"button\" class=\"journal-update btn btn-info entry-update-button\" data-id="
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.journal : depth0)) != null ? stack1.id : stack1), depth0))
